...
url = "https://www.repsol.es/particulares/hogar/luz-y-gas/tarifas/tarifa-10h-descuento/"
...
df.to_csv("resultados_tarifas_repsol_3.csv", index=False)

print("Datos guardados en resultados_tarifas_repsol_3.csv")