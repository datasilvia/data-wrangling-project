...
url = "https://www.repsol.es/particulares/hogar/luz-y-gas/tarifas/tarifa-tranquilisima/"
...
df.to_csv("resultados_tarifas_repsol.csv", index=False)

print("Datos guardados en resultados_tarifas_repsol.csv")